...
.product-section{
    width:1000px;height:auto;margin-left: 340px;
}
.heading
{
    text-align:center; font-size: 48px; color:#a9a9a9; padding:0.8rem;margin:2rem 0; width:1000px;
    background:darkslateblue;text-shadow: 1px 1px 1px #9da3a5; box-shadow: rgba(13,10,0.12) 0px 6px 10px 0px;
}
.heading span
{
...
{
    border-radius:.5rem;flex:1 1 20rem;box-shadow:0 .2rem 1rem purple;
...
.products .box-container .box .image img
{
    ...
    object-fit:contain;width:100%;height:250px;
}
